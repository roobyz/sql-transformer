// SQL Grammer (Snowflake, PostgreSQL, MySQL, T-SQL)
// =================================================================================
//
// Uses PEGGY, a javascript library that takes a PEG (parsing expression grammar)
// and generates a parser program. PEGs cannot be ambiguous; if a string parses, 
// it has exactly one valid parse tree.
//
// Based on grammar from ECMA-262, 5.1 Edition [1]. The enerated parser builds a
...
qualify_clause
  = KW_QUALIFY __ e:expr { /* => expr */ return e; }
